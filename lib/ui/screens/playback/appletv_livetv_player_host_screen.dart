...
class _AppleTvLiveTvPlayerHostScreenState
      ...
      for (final channel in widget.channels)
        {
          ...
          'programLoading':
              _nowPlayingByChannel[channel.id] == null &&
              viewModel?.loadStateFor(channel.id) != GuideChannelLoadState.loaded,
          ..._programPayload(_nowPlayingByChannel[channel.id], l10n, now),
        },
    ];
  }
  ...
  Map<String, dynamic> _programPayload(
    ...
    return {
      ...
      'seasonEpisode': _seasonEpisode(program),
  ...
  String _seasonEpisode(GuideProgram program) {
